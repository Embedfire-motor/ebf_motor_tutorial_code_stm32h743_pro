...
#define HALL_INPUT1_GPIO_PORT     		    GPIOB
#define HALL_INPUT1_GPIO_CLK_ENABLE() 	  __HAL_RCC_GPIOB_CLK_ENABLE()
#define HALL_INPUT1_AF					          GPIO_AF2_TIM4

/* TIM5 通道 2 引脚 */
#define HALL_INPUT2_PIN           		    GPIO_PIN_7
#define HALL_INPUT2_GPIO_PORT     		    GPIOB
#define HALL_INPUT2_GPIO_CLK_ENABLE() 	  __HAL_RCC_GPIOB_CLK_ENABLE()
#define HALL_INPUT2_AF					          GPIO_AF2_TIM4

/* TIM5 通道 3 引脚 */
#define HALL_INPUT3_PIN           		    GPIO_PIN_8
#define HALL_INPUT3_GPIO_PORT     		    GPIOB
#define HALL_INPUT3_GPIO_CLK_ENABLE() 	  __HAL_RCC_GPIOB_CLK_ENABLE()
#define HALL_INPUT3_AF					          GPIO_AF2_TIM4
